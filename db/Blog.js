...
var BlogSql={
    ...
    queryBlogLi:"SELECT  img,name,blog.sendername,blog.likes,blog.time,blog.sendername,blog.id,blog.content,blog.title FROM user RIGHT JOIN blog ON user.username=blog.sendername ORDER BY id DESC limit ?,?",
